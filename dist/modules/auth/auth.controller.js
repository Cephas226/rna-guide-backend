...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email/téléphone déjà utilisé' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Se connecter et obtenir les tokens JWT' }),
    ...
    __param(2, (0, common_1.Headers)('x-app-version')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, public_decorator_1.Public)(),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Renouveler l\'access token via refresh token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Tokens renouvelés' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Déconnexion (révoke le refresh token)' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [refresh_token_dto_1.RefreshTokenDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({ summary: 'Déconnecter tous les appareils' }),
